...
public class Max_International_Enroll {
	...
	@BeforeTest
	public void enroll() {
		driver.findElement(By.xpath("/html/body/div[18]//div[@class='col-md-3']/div[@class='row']/div[5]")).click();
	}
	
	@Test
	public void prefferedCustomer() {
		WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(10));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html//div[@id='enrollmentModal']/div[@role='document']/div[@class='modal-content']//a[@class='enrollUserprefred']"))).click();
		WebDriverWait wait1 = new WebDriverWait(driver,Duration.ofSeconds(10));
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html//button[@id='yesButton']"))).click();
